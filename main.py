...
LOW_BATTERY = 3.3
CRITICAL_BATTERY = 3.2

# 👉 AJUSTA ESTE VALOR TRAS CALIBRAR
...
if DEBUG:
    ...
    while True:
        ...
        # 🔋 batería también en debug (para calibrar)
...
# =========================================================
    ...
    if battery is not None:
        ...
        if battery < CRITICAL_BATTERY:
            print("CRITICAL BATTERY → shutting down safely")

            move_smooth(current_angle, SAFE_ANGLE)
